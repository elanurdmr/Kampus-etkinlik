...
echo Frontend adresi: http://localhost/kampus-etkinlik/yazilim-tasarim-mimarisi-proje/frontend/

echo.
echo ========================================
echo ✓ Backend: http://localhost:8000
echo ✓ Frontend: http://localhost/kampus-etkinlik/yazilim-tasarim-mimarisi-proje/frontend/
echo ========================================
echo.
